...
var getSgguNm = async function (selectSidoNm) {
    var response = await fetch(`http://kseekyoo.us-west-2.elasticbeanstalk.com:80/api/sgguNm?sidoNm=${selectSidoNm}`);
...
var getHospital = async function (sidoNm, sgguNm) {
    ...
    var response = await fetch(`http://kseekyoo.us-west-2.elasticbeanstalk.com:80/api/hospital?sidoNm=${sidoNm}&sgguNm=${sgguNm}`);
    var responseParsing = await response.json();
